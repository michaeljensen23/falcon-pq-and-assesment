...
//#region node_modules/.nitro/vite/services/ssr/assets/client-B6w7Ysfi.js
var client_B6w7Ysfi_exports = /* @__PURE__ */ __exportAll({
	a: () => signIn,
	i: () => oauthPopupTarget,
	n: () => client_exports,
	o: () => signOut,
...
var client_exports = /* @__PURE__ */ __exportAll$1({
	...
	oauthPopupPath: () => oauthPopupPath,
	oauthPopupTarget: () => oauthPopupTarget,
	signIn: () => signIn,
	signOut: () => signOut
});
/**
...
function oauthPopupTarget(providerId) {
	return `grok-signin-${providerId}`;
}
function oauthPopupPath(providerId) {
...
function openSignInPopup(providerId) {
	const url = `${window.location.origin}${oauthPopupPath(providerId)}`;
...
//#endregion
export { signIn as a, oauthPopupTarget as i, client_B6w7Ysfi_exports as n, signOut as o, oauthPopupPath as r, authClient as t };
