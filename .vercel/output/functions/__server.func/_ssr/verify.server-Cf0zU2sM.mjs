...
import { n as auth, r as authConfigured } from "./server-yY5cJ_0I.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-Cf0zU2sM.js
/**
...
async function getSessionUser(bearerToken) {
	...
	if (!isFirmEmail(session.user.email)) return null;
	return {
		id: session.user.id,
